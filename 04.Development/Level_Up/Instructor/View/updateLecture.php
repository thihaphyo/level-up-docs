...
<head>
    ...
    <link rel="stylesheet" href="../View/resources/css/uploadlecture.css?v=<?= $time; ?>">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js?v=<?= $time; ?>"></script>
    <script src="../View/resources/js/uploadlecture.js?v=<?= $time; ?>" defer></script>
        ...
        <form action="../Controller/uploadLectureController.php" method="POST" enctype="multipart/form-data" id="videoUploadForm">
            <div class="left">
                <div class="form-input">
                    <div class="preview">
                        <video id="videoPreview" src="../Storage/videos/<?php $result[0]['lectureVideo'] ?>" />
                    </div>
