      ...
      <div class="mt-6">
        <div class="columns mt-4 pt-3 pb-0">
          <div class="my-profile-image">
            <img
              src="./resources/img/dummyprofile.png"
              alt=""
            />
          </div>
          <div class="column my-profile-info pb-0">
            <div class="my-profile-name-n-edit pt-3 pl-3 pb-0">
              <div class="mt-0">
                <h2 class="has-text-weight-bold has-text-black is-size-5">
                  Michael Jordan
                </h2>
                <h3
                  class="has-text-weight-semibold has-text-black is-size-6 mt-1"
                >
                  Web Designer, Data Engineer
                </h3>
              </div>
              <a href="./editInstructor.php">Edit</a>
            </div>
                ...
                <div class="column is-half">
                    ...
                    <div class="column m-0 p-0 mt-5">
                        <div class="is-flex is-flex-direction-row mt-5">
                            ...
                            <div class="column m-0 p-0 ml-1">
                                <div class="column m-0 p-0 has-text-black has-text-weight-medium ">
                    ...
                    <div class="column m-0 p-0 mt-6">
                        <div class="is-flex is-flex-direction-column mt-5">
                            ...
                            <div class="column m-0 p-0 ml-1">
                                <div class="column m-0 p-0 has-text-black has-text-weight-semibold mt-4 is-size-6">
