    ...
    <main>
        ...
        <div class="container">
            ...
            <section class="section is-medium">
                ...
                <h2 class="is-size-3 has-text-weight-semibold">Free Courses</h2>

            </section>

            <section class="section is-medium">
                <div class="StepOne">
                    <img src="undraw/images.jpg" alt="screenshot">
...
<!-- <div class="firstpoint">
            ...
            <section class="section is-medium">
                <div class="Steptwo">
                    <img src="undraw/images.jpg" alt="Undraw">
            ...
            <section id="paidcourses" class="section is-medium">
                <h1 class="is-size-3 has-text-weight-semibold">Paid Courses</h1>
            </section>


            
            <section class="section is-medium">
                <div class="Steponeforpaid">
                    <img src="undraw/images.jpg" alt="Undraw">
                    <h1 class="is-size-3 has-text-weight-semibold">Step 1</h1>
                    <p class="is-size-6 has-text-weight-medium">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto architecto iure in ipsa impedit quo porro, fugit eveniet at ullam ex accusantium consectetur? Accusantium officia id amet ex quia expedita.</p>
    ...
    <div class="Note">
    <h1 class="is-size-2 has-text-weight-semibold">Text for Note</h1>
                    <p class="is-size-6 has-text-weight-medium">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae inventor
                    </p>
    </div>
