...
<body>
    ...
    <div class="admin-insert header">
        <a href="./dashboard.php">
            <img width="120px" src="./resources/img/level up logo.svg" alt="logo"></img>
        </a>
    </div>
    <div class="container admin-insert">
        ...
        <div class="admin-update-container">
            <form class="admin-form" method="post" action="../Controller/adminController/adminController.php" enctype="multipart/form-data">
                ...
                ?>
                <input type="hidden" value="<?php echo $encryption->stringEncryption('encrypt', 14 . '-insert') ?>" name="adminId">
